...
class TlsSocket final : public FiberSocketBase {
 ...
 private:
  ...
  // Helper to advance an iovec array by consuming 'bytes_to_advance' bytes.
  // Skips fully consumed entries and adjusts the base/length of partially consumed entries.
